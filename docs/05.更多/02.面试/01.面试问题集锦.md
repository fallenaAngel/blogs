...
![JS == 判断转化规则](/blogs/img/problemRecords/20.jpg)
...
![先看效果图](/blogs/img/problemRecords/4.svg)
...
![帧的生命周期](/blogs/img/problemRecords/5.jpg)
...
![font-display效果图](/blogs/img/problemRecords/6.jpg)
...
![preset配置](/blogs/img/problemRecords/7.jpg)
...
![webpack.splitChunks配置](/blogs/img/problemRecords/13.jpg)
...
![Keep Alive配置](/blogs/img/problemRecords/14.jpg)
...
![HTTP资源缓存](/blogs/img/problemRecords/15.jpg)
...
![Service workers](/blogs/img/problemRecords/16.jpg)

再使用workbox-webpack-plugin插件生成service-worker.js

![Service workers](/blogs/img/problemRecords/17.jpg)

swUrl就是用workbox-webpack-plugin插件生成service-worker.js。调用Worker.register()就可以启动功能了。

![Service workers](/blogs/img/problemRecords/18.jpg)

![Service workers](/blogs/img/problemRecords/19.jpg)
