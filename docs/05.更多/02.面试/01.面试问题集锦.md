...
![JS == 判断转化规则](/img/problemRecords/20.jpg)
...
![先看效果图](/img/problemRecords/4.svg)
...
![帧的生命周期](/img/problemRecords/5.jpg)
...
![font-display效果图](/img/problemRecords/6.jpg)
...
![preset配置](/img/problemRecords/7.jpg)
...
![webpack.splitChunks配置](/img/problemRecords/13.jpg)
...
![Keep Alive配置](/img/problemRecords/14.jpg)
...
![HTTP资源缓存](/img/problemRecords/15.jpg)
...
![Service workers](/img/problemRecords/16.jpg)

再使用workbox-webpack-plugin插件生成service-worker.js

![Service workers](/img/problemRecords/17.jpg)

swUrl就是用workbox-webpack-plugin插件生成service-worker.js。调用Worker.register()就可以启动功能了。

![Service workers](/img/problemRecords/18.jpg)

![Service workers](/img/problemRecords/19.jpg)
