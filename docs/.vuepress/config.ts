...
// import { readFileList, readTotalFileWords } from './webSiteInfo/readFile'
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    logo: 'https://fallenaAngel.github.io/picx-images-hosting/layout/dingicon.3go7wm6a0g.svg', // 导航栏logo
    repo: 'fallenaAngel/blogs', // 导航栏右侧生成Github链接
    ...
    bodyBgImg: [
      'https://fallenaAngel.github.io/picx-images-hosting/layout/dingbig_bg1.4jnx8zfqhb.webp',
      'https://fallenaAngel.github.io/picx-images-hosting/layout/dingbig_bg4.8s34it5zat.webp',
      'https://fallenaAngel.github.io/picx-images-hosting/layout/dingbig_bg5.widlgjy0s.webp',
    ...
    author: {
      name: '李丁丁', // 必需
      link: 'https://github.com/fallenaAngel', // 可选的
    },
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://y.music.163.com/m/playlist?id=2734540002&userid=1811148482&creatorId=1811148482',
        },
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        '李丁丁', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  head: [
    ['link', { rel: 'shortcut icon', type: 'image/svg+xml', href: 'https://fallenaAngel.github.io/picx-images-hosting/layout/dingicon.3go7wm6a0g.svg' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
  ...
  plugins: <UserPlugins>[
    ...
    [
      // Gitalk的配置和安装说明：https://www.cnblogs.com/liqingbo/p/15034077.html
