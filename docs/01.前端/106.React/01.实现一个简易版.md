...
permalink: /pages/fereact01simplefulfill/
categories:
  - 前端
  - React
tags:
...
::: tip
以下内容参考自[github](https://github.com/chinanf-boy/didact-explain)，也可以查看[Build your own React](https://pomb.us/build-your-own-react/)，不同之处是后者基于React 16.8可以使用钩子并删除与类相关的所有代码。
:::
